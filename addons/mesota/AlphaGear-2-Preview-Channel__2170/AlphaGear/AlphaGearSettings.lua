...
--> BAERTRAM - FCOIS
AG_OPTION_USE_FCOIS_MARKER_ICONS = 16
--< BAERTRAM - FCOIS
...
function AG:CreateSettingsPage()
	...
	local AGplugFCOIS = plugins.FCOIS
	--< BAERTRAM - FCOIS
...
--[[
		--> BAERTRAM - FCOIS
		{
			...
			controls = {
				{
					type = "checkbox",
					name = OptMsg[AG_OPTION_USE_FCOIS_MARKER_ICONS],
					getFunc = function() return optionsSV[AG_OPTION_USE_FCOIS_MARKER_ICONS] end,
					setFunc = function(value) optionsSV[AG_OPTION_USE_FCOIS_MARKER_ICONS] = value end,
					default = defaults[AG_OPTION_USE_FCOIS_MARKER_ICONS],
					disabled = function() return not AGplugFCOIS.isAddonReady() end
				},
			},
		},
		--< BAERTRAM - FCOIS
	...
	addOnPanel = LAM:RegisterAddonPanel(self.name.."_LAM", panelData)
	LAM:RegisterOptionControls(self.name.."_LAM", optionsTable)
end
