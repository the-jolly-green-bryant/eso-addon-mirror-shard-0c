...
AGLang.msg = {
	...
	SetChangeQueuedMsg = 'Build <<1>> (<<2>>) will be equiped when out-of-combat.',
	...
	-- new since 6.4.1
		--> BAERTRAM - FCOIS
		'Show FCOIS marker icons (inventory)',		-- AG_OPTION_USE_FCOIS_MARKER_ICONS = 16
		--< BAERTRAM - FCOIS
	...
	-- new since 6.4.1
	--> BAERTRAM - FCOIS
	FCOISHeader = 'FCOItemSaver integration',
	FCOISGearMarkerIconLabel = 'Marker icon',
	NoFCOISGearMarkerIconEntry = '-None-',
	--< BAERTRAM - FCOIS
	-- end new since 6.4.1
}
