...
WritCreater.optionStrings['StatusBarIcons']								= "Quest Status Bar Crafting Icons"
WritCreater.optionStrings['StatusBarIconsTooltip']						= "Shows Crafting Icons instead of Characters"
WritCreater.optionStrings['StatusBarBackdropColor']						= "Quest Status Bar Backdrop Transparent"
WritCreater.optionStrings['StatusBarBackdropColorTooltip']				= "Set Quest Status Bar Backdrop Color to Transparent"
