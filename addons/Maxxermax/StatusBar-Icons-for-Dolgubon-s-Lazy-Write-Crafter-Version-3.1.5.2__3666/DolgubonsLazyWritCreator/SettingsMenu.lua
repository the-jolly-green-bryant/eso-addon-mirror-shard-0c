...
function WritCreater.Options() --Sentimental
	...
	local options =  {
		...
		{
			type = "checkbox",
			name = WritCreater.optionStrings['StatusBarBackdropColor'], -- or string id or function returning a string
			getFunc = function() return WritCreater:GetSettings().StatusBarBackdropColor end,
			disabled = function() return not WritCreater:GetSettings().showStatusBar end,
			setFunc = function(value) WritCreater:GetSettings().StatusBarBackdropColor = value end,
			tooltip = WritCreater.optionStrings['StatusBarBackdropColorTooltip'], -- or string id or function returning a string (optional)
			requiresReload = true,
			default = WritCreater.default.StatusBarBackdropColor,
		} ,
		{
			type = "checkbox",
			...
			disabled = function() return not WritCreater:GetSettings().showStatusBar end,
			setFunc = function(value) WritCreater:GetSettings().StatusBarIcons = value end,
