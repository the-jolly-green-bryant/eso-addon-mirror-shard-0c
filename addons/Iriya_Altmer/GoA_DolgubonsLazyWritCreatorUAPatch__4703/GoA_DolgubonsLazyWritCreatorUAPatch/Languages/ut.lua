...
function WritCreater.langWritNames() -- Vital
	...
	local names = {
	["G"] = "Writ",
	[CRAFTING_TYPE_ENCHANTING] = "Enchanter", -- 249936564-0-6495 <Examine the Enchanter Writs.>
...
function WritCreater.langCraftKernels()
	return 
	{
		[CRAFTING_TYPE_ENCHANTING] = "Enchant", -- 81344020-0-425
		[CRAFTING_TYPE_BLACKSMITHING] = "Blacksmith", -- 146361138-0-528
		[CRAFTING_TYPE_CLOTHIER] = "Clothier", -- 146361138-0-832
		[CRAFTING_TYPE_PROVISIONING] = "Provision", -- 68561141-0-180
		[CRAFTING_TYPE_WOODWORKING] = "Woodwork", -- 260523861-5-24
...
function WritCreater.langMasterWritNames() -- Vital
	...
	["M"] 							= "masterful",
	["M1"]							= "master",
	[CRAFTING_TYPE_ALCHEMY]			= "concoction", -- 52420949-0-5983 A Masterful Concoction
