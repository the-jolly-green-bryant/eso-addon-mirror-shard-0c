...
local localization_strings = {
		SI_NBUI_ADDON_NAME = "Notebooks",
		SI_NBUI_ADDONOPTIONS_NAME = "Notebooks Options",
		SI_NBUI_AUTHOR = "Bloodspill",
		SI_NBUI_VERSION_NUM = "|c00FF003.2|r",
			
		-- Settings Panel
		SI_NBUI_DESCRIPTION_INFO = "A Virtual Set of Notebooks.",
		...
		SI_NBUI_NB1INFORMATION_TOOLTIP = "Commands:\n|c00FF00/nb1|r toggles the window on/off.\n|c00FF00/nbs|r toggles the settings on/off.\n|c00FF00/rl|r reloads the user interface.",
		SI_NBUI_NB2INFORMATION_TOOLTIP = "Commands:\n|c00FF00/nb2|r toggles the window on/off.\n|c00FF00/nbs|r toggles the settings on/off.\n|c00FF00/rl|r reloads the user interface.",
		SI_NBUI_NB3INFORMATION_TOOLTIP = "Commands:\n|c00FF00/nb3|r toggles the window on/off.\n|c00FF00/nbs|r toggles the settings on/off.\n|c00FF00/rl|r reloads the user interface.",		
		
		SI_NBUI_NB1KEYBIND_LABEL = "Notebook 1",
		SI_NBUI_NB2KEYBIND_LABEL = "Notebook 2",
		SI_NBUI_NB3KEYBIND_LABEL = "Notebook 3",
	}
